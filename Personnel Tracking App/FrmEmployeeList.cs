...
namespace Personnel_Tracking_App
{
    public partial class FrmEmployeeList : Form
    {
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please select a table value.");
            }
            else
            {
                FrmEmployee frm = new FrmEmployee();
        ...
        private void dataGridView1_RowEnter(object sender, DataGridViewCellEventArgs e)
        {
            ...
            detail.DepartmentID = Convert.ToInt32(dataGridView1.Rows[e.RowIndex].Cells[7].Value.ToString());
            detail.PositionID = Convert.ToInt32(dataGridView1.Rows[e.RowIndex].Cells[8].Value.ToString());
